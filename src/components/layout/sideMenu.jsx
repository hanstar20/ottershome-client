...
import latte from "../../public/assets/img/latte.png";
import dolce from "../../public/assets/img/dolce.png";
import mocha from "../../public/assets/img/mocha.png";
import toffee from "../../public/assets/img/toffee.png";
// react-collapse
...
export default function SideMenu() {
	...
	const [collapseToggle, setCollapseToggle] = useState([false, false, false, false]);
				...
				<MenuWrapper>
					<MenuList>
						<div>
							<MenuItem
								onClick={() => {
									setCollapseToggle((prev) => [!collapseToggle[0], false, false, false]);
								}}>
								<MenuItemWrapper>
									<ParentItemWrapper>
						...
						<div>
							<MenuItem
								onClick={() => {
									setCollapseToggle((prev) => [false, !collapseToggle[1], false, false]);
								}}>
								<MenuItemWrapper>
									<ParentItemWrapper>
										<MenuLogo alt='dolce' src={dolce} />
										<ParentMenu>이용 안내</ParentMenu>
									</ParentItemWrapper>
									<MenuArrowWrapper>
							...
							<Collapse isOpened={collapseToggle[1]}>
								<CollapseDiv>
									<div>
										<StyledLink to='/usage-info' onClick={handleToggleClick}>
											이용 요금 & 운영 시간
										</StyledLink>
									</div>
									<div>
						...
						<div>
							<MenuItem
								onClick={() => {
									setCollapseToggle((prev) => [false, false, !collapseToggle[2], false]);
								}}>
								<MenuItemWrapper>
									<ParentItemWrapper>
						...
						<div>
							<MenuItem
								onClick={() => {
									setCollapseToggle((prev) => [false, false, false, !collapseToggle[3]]);
								}}>
								<MenuItemWrapper>
									<ParentItemWrapper>
